<template>
  ...
  <div class="h-full flex items-center description-1 max-w-[500px]">
   <div
    class="font-fenix text-white relative flex flex-col gap-y-3 move-1"
   >
    ...
    <div class="flex flex-row move-justify-1 gap-x-3">
     <p v-for="tag in tags" :key="tag" class="move-text-1 font-fenix rounded bg-black  2xl:p-1 xl:p-1 sm:p-1 lg:p-1 xs:p-0.5">
      {{ tag[0].toUpperCase() + tag.substring(1, tag.length) }}
     </p>
    </div>
    <div class="flex w-full move-justify-1">
